...
type prop =
    ...
    static member inline content(value: bool) = Interop.mkAttr "children" (unbox value)
    static member inline content(value: float) = Interop.mkAttr "children" (unbox value)
